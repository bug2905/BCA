...
# ================= START =================
speak("Hello, I am kushal's bot. System is fully ready.")
...
while True:
    ...
    elif "close file explorer" in command or "close explorer" in command:
        speak("Closing File Explorer")
        os.system("taskkill /f /im explorer.exe")
        os.system("start explorer")  # taskbar safe
